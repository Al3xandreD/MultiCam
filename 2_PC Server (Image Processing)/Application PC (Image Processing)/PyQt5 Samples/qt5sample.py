...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("posedetectwarn.png"))
        self.label1.setPixmap(QtGui.QPixmap("posedetectwarn.png"))
        self.label2.setPixmap(QtGui.QPixmap("posedetectwarn.png"))
        self.label3.setPixmap(QtGui.QPixmap("posedetectwarn.png"))

        self.label.setMaximumSize(100, 100)
        self.label1.setMaximumSize(100, 100)
        self.label2.setMaximumSize(100, 100)
        self.label3.setMaximumSize(100, 100)
        ...
        self.viewgrid.addWidget(self.label, 0, 0, 1, 1)
        self.viewgrid.addWidget(self.label1, 0, 1, 1, 1)
        self.viewgrid.addWidget(self.label2, 1, 0, 1, 1)
        self.viewgrid.addWidget(self.label3, 1, 1, 1, 1)
