...
from image_ml_utils.datasets import letterbox
from image_ml_utils.torch_utils import select_device
from yolo_models_utils.experimental import attempt_load
from image_ml_utils.general import non_max_suppression_kpt, strip_optimizer
from image_ml_utils.plots import output_to_keypoint
from image_ml_utils.profiler.profiling_recorder import ProfilingRecorder


class PoseEstimator:

    def __init__(self, device_name, poseweights="yolov7-w6-pose.pt"):
        ...
        _ = self.model.eval()
        self.model_stride = 64  # TODO search how to get this according to the loaded model
