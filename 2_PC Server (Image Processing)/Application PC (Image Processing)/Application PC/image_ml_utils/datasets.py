# Dataset image_ml_utils and dataloaders
...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
    ...
    # Use torch.image_ml_utils.data.DataLoader() if dataset.properties will update during training else InfiniteDataLoader()
...
class LoadStreams:  # multiple IP or RTSP cameras
    ...
    def __init__(self, sources='\streams.txt', img_size=640, stride=32):
        ...
        default_IPAdressFilename = '\streams.txt'
...
def extract_boxes(path='../coco/'):  # from image_ml_utils.datasets import *; extract_boxes('../coco128')
...
def autosplit(path='../coco', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from image_ml_utils.datasets import *; autosplit('../coco')
    Arguments
