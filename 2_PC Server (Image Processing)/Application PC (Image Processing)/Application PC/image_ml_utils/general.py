...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        # Compute conf
        if nc == 1:
            x[:, 5:] = x[:, 4:5] # for yolo_models_utils with one class, cls_loss is 0 and cls_conf is always 0.5,
...
def strip_optimizer(f='best.pt', s=''):  # from image_ml_utils.general import *; strip_optimizer()
