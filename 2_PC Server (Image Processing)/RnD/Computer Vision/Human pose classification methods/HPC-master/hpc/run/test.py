...
def getArgs():
    ...
    parser.add_argument("dataset", help="Path to test dataset relative to /dataF/datasets.")
    parser.add_argument("model", help="Path to model relative to /dataF/yolo_models_utils.")
...
def getModel(modelName):
    mod = tf.keras.models.load_model('dataF/yolo_models_utils/' + modelName)
