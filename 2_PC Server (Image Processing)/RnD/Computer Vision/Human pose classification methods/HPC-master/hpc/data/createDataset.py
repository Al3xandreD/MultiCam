...
parser.add_argument("poses", help="Path to folder with your poses folders relative to /dataF/images.")
parser.add_argument("-d", "--dataset_name", help="Path to output dataset file relative to /dataF/datasets.")
parser.add_argument("-a", "--amount", type=int, help="amount of samples in each label (same).")
args = parser.parse_known_args()[0]

path = "dataF/images/" + args.poses
if args.dataset_name is None:
    args.dataset_name = args.poses
dsPath = "dataF/datasets/" + args.dataset_name
...
print("\nDataset created and saved to file dataF/datasets/" + args.dataset_name + ".npz")
