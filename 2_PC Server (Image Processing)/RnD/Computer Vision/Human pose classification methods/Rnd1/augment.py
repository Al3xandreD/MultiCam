...
def parseArgs():
    ...
    parser.add_argument("input", help="Path to folder with original images relative to /dataF/images.")
    parser.add_argument("-o", "--output", help="Path to folder with augmented images relative to /dataF/images.")
...
if __name__ == "__main__":
    args = parseArgs()
    inputPath = "dataF/images/" + args.input + "/"
    if not args.output:
        args.output = args.input + "_aug"
    outputPath = "dataF/images/" + args.output + "/"
    if not os.path.isdir(outputPath) and (args.mirror or args.rotate):
        os.mkdir(outputPath)
    if args.small is not None:
        smallPath = "dataF/images/" + args.small + "/"
