...
parser.add_argument("video", help="path to folder with your video relative to /dataF/videos.")
parser.add_argument("path", help="path to your .p file files relative to /dataF/images.")
args = parser.parse_known_args()[0]
args.path = "dataF/images/" + args.path
