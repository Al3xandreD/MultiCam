...
def getModel():
    try:
        mod = tf.keras.models.load_model('data/yolo_models_utils/' + args.model_name)
...
def saveModel():
    if args.output_model is not None:
        m.save('data/yolo_models_utils/' + args.output_model)
        print("Model saved to /data/yolo_models_utils/" + args.output_model)
    else:
...
if __name__ == '__main__':
    ...
    mc = tf.keras.callbacks.ModelCheckpoint(
        filepath='data/yolo_models_utils/' + output_model,
