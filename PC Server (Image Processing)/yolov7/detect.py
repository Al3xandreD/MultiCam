...
def poseEstimation_run(frame):
    ...
    poseEstimation_out = poseEstimation_out[:, :19, :, :]  # MobileNet output [1, 57, -1, -1], we only need the first 19 elements
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if view_img:
                ...
                #cv2.imshow("roi", roi) # Visualize Region Of Interest (Optional/Debug)
