...
python detect.py --source "C:\Users\rayou\Documents\ENSTA Bretagne\MultiCam\MultiCam[Git]\PC Server (Image Processing)\Application PC (YOLOV7)\streams.txt" --weights "C:\Users\rayou\Documents\ENSTA Bretagne\MultiCam\MultiCam[Git]\PC Server (Image Processing)\Application PC (YOLOV7)\yolov7.pt"